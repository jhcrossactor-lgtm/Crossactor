...
export const config = {
  ...
  genresPath: process.env.NOTE_GENRES_PATH || path.join(ROOT, 'genres.json'),
  affiliatesPath: process.env.NOTE_AFFILIATES_PATH || path.join(ROOT, 'affiliates.csv'),
  proposalsPath: process.env.NOTE_PROPOSALS_PATH || path.join(ROOT, 'proposals.csv'),
